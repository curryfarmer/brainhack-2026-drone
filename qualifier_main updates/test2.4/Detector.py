...
class Detector:
    ...
    def submit_image(self, image: np.ndarray, context: Optional[Dict[str, Any]] = None) -> None:
        if context is None:
            context = {}
        print("[Detector] Image submitted to YOLO queue")
            ...
            try:
                ...
                for result in results:
                    ...
                    if boxes is not None and len(boxes) > 0:
                        ...
                        # Print confidence for every detection in this frame
                        print(f"[Detector] {len(boxes)} detection(s) in frame:")
                        for box in boxes:
                        ...
                        # Also report frames where YOLO found nothing
                        print(f"[Detector] No detections in frame (rgb_path={context.get('rgb_path', 'N/A')})")
